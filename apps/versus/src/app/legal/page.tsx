      ...
      <main className="pt-24 pb-16">
        <div className="max-w-4xl mx-auto px-4">
          <h1 className="text-3xl font-bold mb-8">
            ...
            <span className="text-neon">表記</span>
          </h1>

          <div className="bg-card neon-border rounded-lg p-8 space-y-6">
            <section>
              <h2 className="text-lg font-semibold text-neon mb-2">
                販売業者
              </h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-neon mb-2">所在地</h2>
              <p className="text-muted-foreground">
          ...
          >
            ...
            <span className="text-neon">表示</span>
          </h2>
          ...
          <div className="bg-card neon-border rounded-lg p-8 space-y-6">
            ...
            <section>
              ...
              <a
                ...
                className="text-neon hover:underline text-sm mt-1 inline-block"
              >
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-border">
                      <th className="text-left py-2 px-3 text-neon font-semibold">
                        プラン
                      </th>
                      <th className="text-left py-2 px-3 text-neon font-semibold">
                        3日間データ上限
