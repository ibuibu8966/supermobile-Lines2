                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b bg-gray-50">
                      ...
                      <th className="text-left py-2 px-2 whitespace-nowrap min-w-[80px]">回線タグ</th>
                      <th className="text-left py-2 px-2 whitespace-nowrap min-w-[80px]">予備タグ</th>
                      <th className="text-left py-2 px-2 whitespace-nowrap min-w-[90px]">発送日</th>
                      <th className="text-left py-2 px-2 whitespace-nowrap min-w-[90px]">返却日</th>
                      <th className="text-left py-2 px-2 whitespace-nowrap min-w-[80px]">契約月</th>
                      <th className="text-left py-2 px-2 whitespace-nowrap min-w-[80px]">ステータス</th>
